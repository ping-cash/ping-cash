...
| #22                     | EPIC: Phase 2 — $PING TGE + Foundation + audit + Raydium | IN PROGRESS | claude | All 4 scaffolds reviewed + ADR 0021 pattern catalog (90e77a1) + init-event + L-02 Debug derives + L-03 docstring patterns cross-program: **ping-token 8 fixes, earn-vault 10 fixes (added L-03 Stake/Unstake 707706e), internal-swap 10 fixes (added L-03 SwapUsdcForPing 2e695e7), pomm 11 fixes**. 77 findings filed, **40 scaffold fixes shipped**. Verifier ZERO-DRIFT. Remaining items architectural — need #61 rebuild + ADR 0009 rebuild + Cayman + OtterSec founder gates. |

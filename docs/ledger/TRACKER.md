...
**Last refreshed:** 2026-05-23 — 16 services live; ALL 14 Phase-1 pillars VERIFIED-PASS; 4 Phase-2 Anchor scaffolds landed (#25 earn-vault, #26 internal-swap, #27 POMM, #28 \$PING mint; all do-not-deploy); 4 closed + 17 labeled `status/completed`; 3 blocked-ext
...
| 🟪 `status/uat`         | 0     | —                                            |
| 🟩 `status/completed`   | 21    | #2-#6, #8-#14, #17-#21, #25-#28              |

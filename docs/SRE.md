...
| Scenario                            | Runbook                                                           |
| ----------------------------------- | ----------------------------------------------------------------- |
| Transfer service returning 500s     | [`runbooks/transfer-500.md`](runbooks/) _(to be written)_         |
| Off-ramp webhook signature mismatch | [`runbooks/offramp-webhook-fail.md`](runbooks/) _(to be written)_ |
| Database connection pool exhaustion | [`runbooks/db-pool-exhaustion.md`](runbooks/) _(to be written)_   |
| Redpanda consumer lag spike         | [`runbooks/kafka-lag.md`](runbooks/) _(to be written)_            |

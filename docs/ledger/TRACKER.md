...
**Last refreshed:** 2026-05-23 — 16 services live; ALL 14 Phase-1 pillars VERIFIED-PASS; Earn Vault Anchor scaffold #25 landed (do-not-deploy); 4 closed + 14 labeled `status/completed`; 3 blocked-ext
...
| 🟪 `status/uat`         | 0     | —                                            |
| 🟩 `status/completed`   | 18    | #2-#6, #8-#14, #17-#21, #25                  |

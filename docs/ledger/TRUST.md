...
| 3. Transfer      | `POST /transfers` creates pending transfer                                  | 🔴 UNVERIFIED    | —          | Waiting on transfer-service @69bd6ff image (Kafka-empty fix)                                                                                                                                                                          |
| 3. Transfer      | USDC transfer confirmed on Solana                                           | 🔴 UNVERIFIED    | —          | Wallet service not built                                                                                                                                                                                                              |
| 4. Wallet        | `GET /wallet/address` returns ADR 0007 multi-token acceptedTokens           | 🟢 VERIFIED-PASS | 2026-05-23 | [docs/walks/2026-05-23-wallet-pillar-walk.md](https://github.com/ping-cash/ping-cash/blob/main/docs/walks/2026-05-23-wallet-pillar-walk.md) — 9 tokens + Jupiter auto-swap policy returned                                            |
| 4. Wallet        | `GET /wallet/balance` rejects invalid Solana address (stub-mode validation) | 🟢 VERIFIED-PASS | 2026-05-23 | Same walk — INVALID_ADDRESS error proves the base58 guard works                                                                                                                                                                       |
...
| 10. Gamification | Pod healthy + handles transfer/referral events                              | 🟢 VERIFIED-PASS | 2026-05-23 | Pod Ready; POST /gamification/events/transfer + /events/referral validated with proper UUID schema — `progressed: ["complete_50_sends"]` returned on transfer event                                                                   |

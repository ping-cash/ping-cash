...
| #22                     | EPIC: Phase 2 — $PING TGE + Foundation + audit + Raydium | IN PROGRESS | claude | All 4 scaffolds reviewed + ADR 0021 catalog + 45 scaffold fixes / 77 findings + verifier ZERO DRIFT × 2. **#62 rebuild progress: internal-swap H-04 Pyth band-check ACTIVE on BOTH swap directions** — pyth-sdk-solana=0.10.5 dep pinned (a92e86f + cf1f6be helpers); wired into swap_usdc_for_ping (ee132a2) + swap_ping_for_usdc (2916a71); 3% deviation band + 60s staleness + positive-price guards; defends sandwich/stale-pool/manipulation. 1 of 7 #62 acceptance criteria closed. Cayman + OtterSec founder gates. |

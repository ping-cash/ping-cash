...
| **Domestic e-wallets** _(not competitors — see next section)_ | GCash, Maya, M-Pesa, Paytm                           |
...
_\* Ping network effects are low today but designed to grow virally_
...
This is the most common confusion. People in the Philippines use GCash daily and wonder: _"Why do I need Ping when I already have GCash?"_
...
> They don't _need_ Ping. You can send money via a claim link, and they cash out to GCash. But if they DO download Ping, future transfers are _completely free_.

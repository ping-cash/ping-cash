...
| #22                     | EPIC: Phase 2 — $PING TGE + Foundation + audit + Raydium | IN PROGRESS | claude | All 4 scaffolds reviewed: **ping-token 3 fixes, earn-vault 7/9 C/H, internal-swap 6/11 C/H, pomm 5/9 C/H (C-04 1f995d7 + H-02 c530322 + H-03 b464d17 + H-04 a6f48e0 + H-05 2f10110, banner 3a2d1b5)**. 77 findings filed total, 21 fixes shipped scaffold-side. Per-mint PDA pattern + rotate_authority + vault-init constraints consistent across all 4 programs. #61 covers earn-vault rebuild. Cayman + OtterSec are founder gates. |

...
| 4. Wallet        | `GET /wallet/balance` synthetic \$5 USDC for OTP_TEST_PHONES JWT            | 🟢 VERIFIED-PASS    | 2026-05-29 | Live curl with isTest:true JWT → `{USDC:"5.00", vUSDC:"0", PING:"0", totalUsdValue:"5.00"}` — symmetric test-phone bypass for #74 demo                                                                                                |

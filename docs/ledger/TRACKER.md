...
**Last refreshed:** 2026-05-23 — 16 services live; ALL 14 Phase-1 pillars VERIFIED-PASS; 4 Anchor scaffolds + KYC service + ping-side kyc-client + tier middleware (user-svc) + tier enforcement (transfer-svc) (#25-#31); 24 labeled `status/completed`; 3 blocked-ext (real KYBs)
...
| 🟪 `status/uat`         | 0     | —                                            |
| 🟩 `status/completed`   | 24    | #2-#6, #8-#14, #17-#21, #25-#31              |

...
| #22                     | EPIC: Phase 2 — $PING TGE + Foundation + audit + Raydium | IN PROGRESS | claude | All 4 scaffolds reviewed: **ping-token 3 fixes, earn-vault 7/9 C/H, internal-swap 6/11 C/H, pomm 6/9 C/H (added H-01 600c647 + C-04 1f995d7 + H-02 c530322 + H-03 b464d17 + H-04 a6f48e0 + H-05 2f10110)**. 77 findings filed, **22 scaffold fixes shipped**. Per-mint PDA pattern + rotate_authority + vault-init constraints + caller-trust hard-disables consistent across all 4 programs. Remaining all-architectural — addressed by #61 rebuild + ADR 0009 rebuild + Cayman + OtterSec founder gates. |
